...
1. Сделал сетку из 4х видосов, однако анимация разворачивания на фуллскрин вышла неочень + слетает адаптивность изза того что приходится конвертировать % в px, видео отрисовывется на канвасе. При клике на видео, оно разворачивается на всю страницу. Кнопка "все камеры" добавлена

2. Добавил для видео инпуты `type=range`, с их помощью можно регулировать яркость и контрастность

3. Анализатор звука прикручен, рисуется прямо на канвасе в нижнем правом углу видео

4. (Бонус) Детектор движения сделал, используя форму нахождения относительной яркости (https://habr.com/ru/post/304210/), сравнивал 2 набора пикселей, находил брект и отрисовывал его на канвасе